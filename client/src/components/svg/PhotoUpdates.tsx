...
const PhotoUpdates = () => {
  return (
    ...
    >
      ...
      />
      <path fill='#aaa' d='M32.68,33.81a22.69,22.69,0,0,0,6.49-2.33' />
      <path
        fill='transparent'
        stroke='#aaa'
      ...
      />
      <path fill='#aaa' d='M13.72,39.52a17.64,17.64,0,0,1-5-1.81' />
      <circle fill='#aaa' cx='9.49' cy='27.33' r='1.83' />
      <circle fill='#aaa' cx='16.67' cy='27.33' r='1.83' />
      <circle fill='#aaa' cx='23.85' cy='27.33' r='1.83' />
      <circle fill='#aaa' cx='31.86' cy='16.83' r='1.83' />
      <circle fill='#aaa' cx='39.04' cy='16.83' r='1.83' />
    </svg>
  );
};
